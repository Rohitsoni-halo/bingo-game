...
def easy_level():
    ...
    check=0
    while(check==0):
        custom=int(input("Press 1 to create a random bingo\nPress 2 to create a custom bingo\n"))
        if(custom==1):
            user_bingo=create_system_bingo()
            check=1
        elif(custom==2):
            ...
            print("Invalid Input\n Please Enter again" )
    print("The bingo created by you is\n\n")
